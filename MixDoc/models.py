...
class Resume(models.Model):
    ...
    qulification = models.CharField(max_length=50,null=True, blank=True)
    clg_name = models.CharField(max_length=150,null=True, blank=True)
    ...
    #certificate_your = models.CharField(max_length=100)
